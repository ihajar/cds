...
// export function formatPriceFilter({
//   price,
//   currency
// }: FormatPriceArgs) {
//   if (!price) return "0";
...
//   const validCurrency = currency ? currencyMap[currency] : "DZD";

//   let convertedPriceInDZD: number;

//   switch (validCurrency) {
//     case "EUR":
//       convertedPriceInDZD = (price / 100) * (1 / defaultExchangeRates.EUR) * defaultExchangeRates.DZD;
//       break;
//     case "GBP":
//       convertedPriceInDZD = (price / 100) * (1 / defaultExchangeRates.GBP) * defaultExchangeRates.DZD;
//       break;
//     case "USD":
//       convertedPriceInDZD = (price / 100) * defaultExchangeRates.DZD;
//       break;
//     default:
//       convertedPriceInDZD = price;
//       break;
//   }
//   const formatter = new Intl.NumberFormat("en-US", {
//     style: "currency",
...
//     maximumFractionDigits: 0,
//   });
//   return formatter.format(convertedPriceInDZD);
// }
