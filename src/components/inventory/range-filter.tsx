...
import { formatNumber, formatPrice, formatPriceFilter } from "@/lib/utils";
...
export const RangeFilter = (props: RangeFilterProps) => {
    ...
    const [maxOptions, setMaxOptions] = useState<FilterOptions<string, number>>(initialState);
